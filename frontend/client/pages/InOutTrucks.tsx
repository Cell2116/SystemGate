...
// import { PhotoCapture } from "../components/trucks/camera/PhotoCapture";
// import { useCameraCapture } from "../hooks/useCameraCapture";
// import { TruckFormData, OperationType, CameraTarget, InputMode } from "../types/truck.types";
// import { INITIAL_FORM_DATA, VALIDATION_MESSAGES } from "../constants/truck.constants";
...
//   // Use our new form steps hook while maintaining the same interface
//   const {
//     formStep,
//     operationType,
//     validationError,
...
//   // Camera hook untuk handle semua camera logic
//   const {
//     showCamera,
//     cameraTarget,
//     capturedImages,
...
//   // Use our ticket generation hook
...
//   // Updated submit functions that use our new hooks
//   const handleSubmitBongkar = async () => {
//     if (!validateAllSteps) {
//       setValidationError(
//         "Masih ada data yang belum lengkap. Mohon periksa kembali semua form.",
//       );
//       return;
//     }
...
//     );
//     const pending = operationTrucks.filter(
//       (truck) => truck.status === "Waiting",
//     ).length;
//     const loading = operationTrucks.filter(
//       (truck) => truck.status === "Loading",
//     ).length;
//     const finished = operationTrucks.filter(
//       (truck) => truck.status === "Finished",
//     ).length;
...
//                   {/* Next/Submit buttons using form steps logic */}
