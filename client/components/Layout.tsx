...
//   DoorOpen,
// } from "lucide-react";
// import { roleAccess } from "@/authentication/accessControl";
...
// const filteredNavigation = navigation.filter(item => roleAccess[item.name as keyof typeof roleAccess]?.includes(userRole));
